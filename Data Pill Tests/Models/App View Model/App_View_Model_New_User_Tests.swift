//
//  App_View_Model_New_User_Tests.swift
//  Data Pill Tests
//
...
final class App_View_Model_New_User_Tests: XCTestCase {
    ...
    func load_fresh_remote_database() throws {
        remoteDatabase = MockCloudDatabase()
    }
    
    func setup_up_app_view_model() throws {
        appViewModel = createAppViewModel(
            ...
            networkConnectionRepository: MockHasNetworkConnectionRepository(),
            setupValues: true
        )
    }
    ...
    func test_on_launch_app_new_user() throws {
        ...
        XCTAssertTrue(appViewModel.hasInternetConnection)
